 <div class="header">
                           ...
                           {{--  <li class="nav-item dropdown notification_dropdown">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="admin/assets/javascript:;" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="{{URL::to('')}}/media/admin/{{Auth::user() -> profile_picture}}" width="20" height="20" alt=""/>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a id="logout_btn_id" href="" class="dropdown-item ai-icon">
        ...
        <form id="logout_form_submit" action="{{ route('logout') }}" method="POST">
        	@csrf
        </form>